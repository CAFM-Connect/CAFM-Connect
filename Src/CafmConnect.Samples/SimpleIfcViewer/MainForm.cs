...
namespace CafmConnect.Samples.SimpleIfcViewer
{
    public partial class MainForm : Form
    {
        ...
        private void PopulateDocument(string fullName)
        {
            ...
            Workspace.Current.LoadCcFile(fullName);

            var document = Workspace.Current.Documents[fullName];
